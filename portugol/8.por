programa
{
	...
	funcao inicio()
	{
		...
		inteiro imposto, distribuidor,fabrica,valorfabrica
		...
		valorfabrica = (fabrica+imposto+distribuidor)
		escreva("O consumidor vai pagar por um carro:    ",valorfabrica,    " mil.  ")
